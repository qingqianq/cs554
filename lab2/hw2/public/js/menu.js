...
$(document).ready(function(){
    ...
    for(let i = 0; i < lineNum; ++i){
        ...
        $('#girdRow').append(grid);
        // use same class gridNum have to use the father selector
    ...
    function modal(){
        ...
        $("#exampleModalLong").find(".modal-title").text(productName);
        $("#exampleModalLong").find(".modal-body").text(productName.toUpperCase()+"'s fake description with more detail.\n\n" + "Why people love money?\n" + answer );
    }
});
